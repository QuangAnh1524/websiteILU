                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                    ...
                                    @foreach ($item->children as $childCategory)
                                        <a href="{{ route('client.product.index', ['categoryID' => $childCategory->id]) }}"
                                           class="dropdown-item">{{ $childCategory->name }}</a>
                                    @endforeach
                                </div>
                            </div>
                        @else
                            <a href="{{ route('client.product.index', ['categoryID' => $item->id]) }}"
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        <a href="{{ route('client.home.index') }}" class="nav-item nav-link active">Home</a>


                        <a href="{{ route('client.home.index') }}" class="nav-link">Order</a>
